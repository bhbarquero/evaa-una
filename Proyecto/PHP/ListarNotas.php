    <?php 
    	...
    	$consultaTipos = "SELECT (tb_tipoasignacion.Id_tipoasignacion) AS Id, (tb_tipoasignacion.Descripcion) AS De,               (tb_porcentajeasignaciones.Porcentaje) AS Po 
			  FROM tb_tipoasignacion, tb_porcentajeasignaciones
              WHERE tb_tipoasignacion.Id_tipoasignacion = tb_porcentajeasignaciones.Id_tipoasignacion"; 
    
    	$consultaNotas = "SELECT Nota FROM tb_usuario, tb_entregaasiganacion, tb_matricula, tb_grupo
              WHERE tb_entregaasiganacion.CorreoUsuario = '".$_SESSION['user']."'
              AND tb_entregaasiganacion.CorreoUsuario = tb_matricula.CorreoUsuario  
